...
function toggleMatches() {
    const matches = document.querySelectorAll('span.match');
	// console.log(matches);

    matches.forEach(element => {
        element.classList.toggle('no_highlight');
    })
	// alert("after toggle");
}
</script>
...
<?php 
echo "See diplomatic folio (w/image): <a href='".$doc1url."' target='_blank'>".$doc1url." (new window)</a><br/><br/>";
...
<td width="40%" valign="top">
<?php 
echo "See diplomatic folio (w/image): <a href='".$doc2url."' target='_blank'>".$doc2url." (new  window)</a><br/></br>";
